...
OPCODES = {
    ...
    0x32f: ("SetPlayerDirection", 1, 0, True),
    0x330: ("SetActiveEntity", 1, 0, True),
    0x331: ("ExitVehicle", 0, 0, False),
    0x332: ("Unknown332", 0, 0, False),
    0x333: ("RotateEntityToModel", 2, 0, True),
    0x334: ("WaitForFunction", 0, 0, False),
    0x336: ("SetEntitySpeedOnWalkmesh", 1, 0, True),
    0x339: ("HideCurrentEntityModel", 0, 0, False),
    0x33a: ("SetEntityVerticalSpeed2", 1, 0, True),
...
FIELD_IDS = {
    ...
    '2': 'Kalm',
    '3': 'ChocoboFarm',
    '4': 'MythrilMinesFromSwamp',
    '5': 'MythrilMinesFromCondor',
    '6': 'FortCondor',
    '7': 'Junon',
    ...
    '21': 'LucreciasCave',
    '22': 'HpMpCave',
    '23': 'PlainsOutsideWutai',
    '24': 'MimeCave',
    '25': 'BoneVillage',
    '26': 'CorralValleyCave',
    '27': 'IcicleVillageSouth',
    '28': 'ChocoboSageHouse',
    '29': 'KnightsOfTheRoundCave',
    '30': 'UnderwaterReactor',
    '31': 'SunkenGelnika',
    '32': 'ImpaledZolom',
    '33': 'YuffieEncounter',
    '34': 'PlainsOutsideWutai2',
    '35': 'PlainsOutsideWutai3',
    '36': 'CargoShip',
    '37': 'CostaDelSolHarbor',
    '38': 'CostaDelSolHarbor2',
    '39': 'JunonDock',
    '40': 'TinyBroncoCrash',
    '41': 'HighwindBridge',
    '42': 'SubmarineBridge',
    '43': 'NibelheimNorth',
    '44': 'MtNibelFromRocketTown',
    '45': 'HighwindBridge2',
    '46': 'MtNibelFromNibelheim',
    '47': 'IcicleVillageNorth',
    '48': 'GreatGlacier',
    '49': 'RocketTownNorth',
    '50': 'HighwindBridge3',
    '51': 'HighwindBridge4',
    '52': 'HighwindBridge5',
    '53': 'DiamondWeaponEncounter',
    '54': 'SubmarineBridge2',
    '55': 'AncientForest',
    '56': 'SubmarineBridge3',
    '57': 'CorralValley',
