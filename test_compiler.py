...
class CompilerTest(TestCase):
    ...
    def test_simple_func(self):
        CompilerTest.assert_compiled('PlayLayerAnimation(0x06)', '0001 1001 0600 4a03')
        CompilerTest.assert_compiled('SetEntityAltitudeOffset(-400)', '0001 1001 9001 1500 0b03')

    def test_comment(self):
        CompilerTest.assert_compiled('LoadModel(0) # loads a model', '0001 1001 0000 0003')

    def test_nested_func(self):
        CompilerTest.assert_compiled('WriteTo(TempByte(2), SpecialByte(15))', '0001 1901 0200 1b01 0f00 e000')

    def test_model_func(self):
        CompilerTest.assert_compiled('RunModelFunction($Highwind, 20)', '0001 1001 0300 1802')
        CompilerTest.assert_compiled('RunModelFunction(SpecialByte($PlayerEntityModelId), 29)', '0001 1b01 0800 2102')

    def test_constants(self):
        CompilerTest.assert_compiled('SetEntityDirection(SpecialByte($EntityDirection) + 128)',
                                     '0001 1b01 0400 1001 8000 4000 0403')

    def test_goto(self):
        CompilerTest.assert_compiled('@LABEL_1\nLoadModel(0)\nGoTo @LABEL_1',
                                     '0001 1001 0000 0003 0002 0000')
        CompilerTest.assert_compiled('LoadModel(0)\n@LABEL_1\nLoadModel(1)\nGoTo @LABEL_1',
                                     '0001 1001 0000 0003 0001 1001 0100 0003 0002 0400')
        CompilerTest.assert_compiled('GoTo @LABEL_1\nLoadModel(0)\n@LABEL_1\nLoadModel(1)',
                                     '0002 0600 0001 1001 0000 0003 0001 1001 0100 0003')

    def test_savemap_and_math(self):
        CompilerTest.assert_compiled('WriteTo(SavemapBit(0x0F29, 3), 1)', '0001 1401 2b1c 1001 0100 e000')
        CompilerTest.assert_compiled('WriteTo(SavemapByte(0x0C14), SavemapByte(0x0C14) - 1)',
                                     '0001 1801 7000 1801 7000 1001 0100 4100 e000')
        CompilerTest.assert_compiled('SetEntityAltitudeOffset(SavemapWord(0x0C16) - 3685 >> 1)',
                                     '0001 1c01 7200 1001 650e 4100 1001 0100 5100 0b03')
        CompilerTest.assert_compiled('WriteTo(TempByte(0), SpecialByte($Random8BitNumber) * 9 >> 8)',
                                     '0001 1901 0000 1b01 1000 1001 0900 3000 1001 0800 5100 e000')

    def test_conditions(self):
        CompilerTest.assert_compiled('If GetDistanceToModel($GoldSaucer) <= 100 Then\nUnknown30d()\nEndIf',
                                     '0001 1001 0e00 1900 1001 6400 6200 0102 0a00 0d03')
        CompilerTest.assert_compiled('If SavemapWord($GameProgress) == 1596 Then\n'
                                     'If GetDistanceToPoint(9) <= 256 Then\n'
                                     '  EnterFieldLevel(52, 0)\n'
                                     'EndIf\nEndIf\nLoadModel(0)\nEnd',
                                     '0001 1c01 0000 1001 3c06 7000 0102 1700 0001 1001 0900 1800 1001 0001 6200 0102 '
                                     '1700 0001 1001 3400 1001 0000 1803 0001 1001 0000 0003 0302')
    ...
    def test_reset(self):
        CompilerTest.assert_compiled('If SavemapByte(0x0C15) < 5 Then\n'
                                     ...
                                     'PlaySound(434)\n'
                                     'End',
                                     '0001 1801 7100 1001 0500 6000 0102 0c00 0001 1001 b101 1d03 0001 1001 b201 '
                                     '1d03 0302')
    ...
    def test_complex(self):
        CompilerTest.assert_compiled('''
            ...
            EndIf
            @LABEL_1
            End''', '0001 1b01 0800 1001 0600 7000 0102 632a 0001 1401 790e 1700 0102 552a 0001 1001 0000 0703 0001 '
                    '1001 0600 1602 0002 632a 0001 1401 7a0e 1700 0102 632a 0001 1001 0000 0703 0001 '
